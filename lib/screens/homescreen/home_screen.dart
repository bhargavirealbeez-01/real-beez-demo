...
class _HomeScreenState extends State<HomeScreen> {
  ...
  final List<Map<String, dynamic>> propertyListings = [
    {
      ...
      'property': Property(
        ...
        images: [PropertyImage(url: 'assets/images/property1.png', isPrimary: true)],
        features: [],
        amenities: [],
      ),
    },
    {
      ...
      'property': Property(
        ...
        images: [PropertyImage(url: 'assets/images/property2.png', isPrimary: true)],
        features: [],
        amenities: [],
      ),
    },
    {
      ...
      'property': Property(
        ...
        images: [PropertyImage(url: 'assets/images/property3.png', isPrimary: true)],
        features: [],
        amenities: [],
      ),
    },
  ...
  Widget _buildBody() {
    ...
    return Stack(
      children: [
        ...
        if (showWave)
          Positioned(
            top: -_scrollOffset.clamp(0.0, screenHeight * 0.60), // Moves up with scroll
            left: 0,
            right: 0,
            child: Container(
              ...
              Padding(
                ...
                child: Row(
                  ...
                  children: [
                    Row(
                      children: [
                        Icon(Icons.location_on, color: showWave ? Colors.white : Colors.black, size: isSmallScreen ? 18 : 20),
                        SizedBox(width: isSmallScreen ? 4 : 6),
                        Text("Hyderabad, TG", style: TextStyle(color: showWave ? Colors.white : Colors.black, fontWeight: FontWeight.bold, fontSize: isSmallScreen ? 14 : 16)),
                        Icon(Icons.arrow_drop_down, color: showWave ? Colors.white : Colors.black, size: isSmallScreen ? 18 : 20),
                      ],
                    ),
                    Row(
                      children: [
                        GestureDetector(
                          ...
                          child: Stack(
                            children: [
                              Icon(Icons.notifications, color: showWave ? Colors.white : Colors.black, size: isSmallScreen ? 22 : 28),
                              Positioned(
                                right: 0,
                                child: Container(
                ...
                children: [
                  SizedBox(
                    ...
                    child: Row(
                      ...
                      children: List.generate(tabs.length, (index) {
                        ...
                        final Color selectedColor = index == 0 ? allTabEndColor : tabColors[index];
                        final Color unselectedColor = selectedIndex == 0 ? (showWave ? Colors.white : Colors.black) : Colors.black;
                        return GestureDetector(
                          key: _tabKeys[index],
                          onTap: () {
                            setState(() { selectedIndex = index; });
                            WidgetsBinding.instance.addPostFrameCallback((_) { _updateCapsulePosition(); });
                          },
                          child: Column(
                            ...
                            children: [
                              ...
                              tabs[index].imagePath != null
                                  ? Image.asset(tabs[index].imagePath!, height: isSmallScreen ? 20 : 24, width: isSmallScreen ? 20 : 24, color: isSelected ? selectedColor : unselectedColor)
                                  : Icon(tabs[index].icon!, color: isSelected ? selectedColor : unselectedColor, size: isSmallScreen ? 20 : 24),
                              SizedBox(height: 4),
                              Text(tabs[index].label, style: TextStyle(color: isSelected ? selectedColor : unselectedColor, fontWeight: isSelected ? FontWeight.bold : FontWeight.normal, fontSize: isSmallScreen ? 10 : 12)),
                              SizedBox(height: 10),
                            ],
                          ),
                        );
                  ...
                  Positioned(
                    ...
                    child: CustomPaint(
                      ...
                      painter: CapsuleWaveLinePainter(centerX: capsuleCenterX, capsuleWidth: capsuleWidth, capsuleHeight: 30, borderRadius: 10),
                    ),
                  ),
                ],
              ),
        ...
        children: [
                ...
                Padding(
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      image: DecorationImage(image: AssetImage('assets/images/special_offers.png'), fit: BoxFit.cover),
                    ),
                  ),
                ),
                Expanded(
                  child: PageView.builder(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      return _buildOfferCard(imageUrl: offer['image']!, title: offer['title']!);
                    },
                  ),
                ),
              ],
          ...
          Center(
            child: SmoothPageIndicator(
              ...
              effect: WormEffect(dotColor: Colors.white54, activeDotColor: Colors.white, dotHeight: 6, dotWidth: 6),
            ),
          ),
          SizedBox(height: 30),
          ...
          Container(
            ...
            child: NotificationListener<ScrollNotification>(
              ...
              child: ListView.builder(
                ...
                physics: BouncingScrollPhysics(), // Enable manual scrolling with bounce effect
  ...
  Widget _buildFeaturedSitesSection() {
    ...
    if (selectedIndex == 1) {
      categoryTitles = ['2 BHK Apartments', '3 BHK Apartments', '4 BHK Apartments'];
      categoryData = [
        {
          'items': [
            {
      ...
      categoryTitles = ['Small Farmlands', 'Medium Farmlands', 'Large Farmlands'];
      categoryData = [
        {
          'items': [
            {
            ...
            Row(
              ...
              children: [
                ...
                Container(
                  ...
                  child: Row(
                    children: [
                      Icon(Icons.filter_list, size: isSmallScreen ? 16 : 18, color: Color(0xFFD79A2F)),
                      SizedBox(width: 6),
                      Text(
                        'Filter',
                        style: TextStyle(
                    ...
                    SizedBox(
                      ...
                      child: ListView.builder(
                        ...
                        itemBuilder: (context, idx) {
                          ...
                          return _buildPropertyCard(property: property, index: idx);
                        },
                      ),
                    ),
  ...
  Widget _buildPropertyCard({required Map<String, dynamic> property, required int index}) {
    final screenWidth = MediaQuery.of(context).size.width;
    final isSmallScreen = screenWidth < 360;
                      ...
                      children: [
                        ...
                        Row(
                          children: [
                            ...
                            SizedBox(width: 6),
                            // Wishlist icon
                            _AnimatedWishlistButton(property: property['property']),
                          ],
                        ),
                      ],
                    ),
  ...
  Widget _buildOfferCard({required String imageUrl, required String title}) {
    ...
    return Container(
      ...
      width: isSmallScreen ? screenWidth * 0.20 : isMediumScreen ? screenWidth * 0.17 : screenWidth * 0.14,
      decoration: BoxDecoration(
        color: Colors.white,
        ...
        children: [
          ClipRRect(
            ...
            child: imageUrl.startsWith('assets/')
                ? Image.asset(imageUrl, height: isSmallScreen ? 74 : 90, width: double.infinity, fit: BoxFit.cover)
                : Image.network(imageUrl, height: isSmallScreen ? 74 : 90, width: double.infinity, fit: BoxFit.cover),
          ),
          Padding(
            ...
            child: Column(
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                Text("More Details:", style: TextStyle(fontWeight: FontWeight.w500, fontSize: isSmallScreen ? 10 : 11)),
                SizedBox(height: 3),
                Text(title, style: TextStyle(fontWeight: FontWeight.bold, fontSize: isSmallScreen ? 12 : 13), maxLines: 2, overflow: TextOverflow.ellipsis),
                ...
                SizedBox(
                  ...
                  child: ElevatedButton(
                    ...
                    onPressed: () {},
                    child: Text("Unlock the Offers", style: TextStyle(color: Colors.white, fontSize: isSmallScreen ? 10 : 12)),
                  ),
                ),
              ],
            ),
...
class CapsuleWaveLinePainter extends CustomPainter {
  ...
  CapsuleWaveLinePainter({required this.centerX, required this.capsuleWidth, required this.capsuleHeight, this.borderRadius = 8});
  ...
  void paint(Canvas canvas, Size size) {
    ...
    path.moveTo(0, 0);
    path.lineTo(leftX, 0);
    path.arcToPoint(Offset(leftX + borderRadius, -borderRadius), radius: Radius.circular(borderRadius), clockwise: false);
    path.lineTo(leftX + borderRadius, -capsuleHeight + borderRadius);
    path.arcToPoint(Offset(leftX + borderRadius * 2, -capsuleHeight), radius: Radius.circular(borderRadius), clockwise: true);
    path.lineTo(rightX - borderRadius * 2, -capsuleHeight);
    path.arcToPoint(Offset(rightX - borderRadius, -capsuleHeight + borderRadius), radius: Radius.circular(borderRadius), clockwise: true);
    path.lineTo(rightX - borderRadius, -borderRadius);
    path.arcToPoint(Offset(rightX, 0), radius: Radius.circular(borderRadius), clockwise: false);
  ...
  bool shouldRepaint(covariant CapsuleWaveLinePainter oldDelegate) {
    return oldDelegate.centerX != centerX || oldDelegate.capsuleWidth != capsuleWidth || oldDelegate.capsuleHeight != capsuleHeight || oldDelegate.borderRadius != borderRadius;
  }
}
...
class TopGradientWavePainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    final gradient = LinearGradient(
      colors: startColor != null && endColor != null ? [startColor!, endColor!] : [Color(0xFFE8ECFC), color!.withOpacity(0.8)],
  ...
  @override
  bool shouldRepaint(covariant TopGradientWavePainter oldDelegate) => oldDelegate.color != color || oldDelegate.startColor != startColor || oldDelegate.endColor != endColor;
}
