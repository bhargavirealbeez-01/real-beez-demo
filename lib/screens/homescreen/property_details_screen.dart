...
Container(
  ...
  child: Row(
    ...
    SizedBox(width: 20),
      Expanded(
        child: Padding(
          padding: const EdgeInsets.only(left: 8), // slight gap after icons
          child: SizedBox(
            height: 48,
            width: 100,
...
class _TestimonialSectionState extends State<TestimonialSection> {
  ...
  void initState() {
    ...
    _controllers = testimonials
        .map((t) => VideoPlayerController.asset(t.videoAsset)
          ...
          children: List.generate(testimonials.length, (index) {
            return AnimatedContainer(
              ...
              decoration: BoxDecoration(
                shape: BoxShape.circle,
                color:
                    activeIndex == index ? Colors.black87 : Colors.grey[400],
              ),
            );
          }),
        ),
