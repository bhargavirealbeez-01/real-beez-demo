        ...
        SizedBox(
          ...
          child: ElevatedButton(
            style: ElevatedButton.styleFrom(
              backgroundColor: const Color(0xFFD7A44B),
            ...
            onPressed: () {
              showDialog(
                ...
                builder: (context) => CancelReschedulePopup(
                  onRescheduleNow: () {
                    Navigator.of(context).pop();
...
class CancelReschedulePopup extends StatefulWidget {
  final VoidCallback onRescheduleNow;
  final VoidCallback onCancelBooking;
  
  const CancelReschedulePopup({
    super.key, 
  ...
  @override
  State<CancelReschedulePopup> createState() => _CancelReschedulePopupState();
}

class _CancelReschedulePopupState extends State<CancelReschedulePopup> {
  String _dropdownValue = "Reschedule Now";
          ...
          child: Column(
            ...
            children: [
              ...
              const Align(
                ...
                child: Text(
                  "Rescheduling for Reason",
                  style: TextStyle(
                    color: Color(0xFFFCB73B),
                    fontSize: 15,
                    fontWeight: FontWeight.bold,
                  ),
                ),
                    ...
                    child: Row(
                      children: [
                        Radio<String>(
                          ...
                          activeColor: const Color(0xFFFCB73B),
                          onChanged: (value) {
                            setState(() {
              ...
              SizedBox(
                ...
                child: ElevatedButton(
                  ...
                  onPressed: _dropdownValue == "Reschedule Now" 
                      ? widget.onRescheduleNow
                      : widget.onCancelBooking,
                  child: Text(
                    _dropdownValue == "Reschedule Now" 
                        ? "Reschedule Now"
                        : "Cancel Booking",
                    style: const TextStyle(
                        fontSize: 16,
